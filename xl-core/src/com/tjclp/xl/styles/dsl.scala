 ...
 *   val styles = CellStyle.default.bold.size(14.0).red.bgBlue.center
 *
...
object dsl:
  ...
  extension (style: CellStyle)
     ...
     * validated at runtime (silent fail if invalid, styles unchanged).
     *
     * Examples:
     * {{{
     * styles.hex("#FF0000")     // ✅ Compile-time validated
     * styles.hex("#GGGGGG")     // ❌ Compile errors: Invalid hex
     * styles.hex(userInput)     // ✅ Runtime validated (silent fail if invalid)
     * }}}
     */
     ...
     * Examples:
     * {{{
     * styles.bgHex("#F5F5F5")   // ✅ Compile-time validated
     * styles.bgHex("#ZZZZZZ")   // ❌ Compile errors: Invalid hex
     * styles.bgHex(userBg)      // ✅ Runtime validated (silent fail if invalid)
     * }}}
     */
  ...
  /**
   * Common styles presets for quick access.
   *
  ...
  object Style:
    ...
    /** Red, bold, italic - typical for errors messages */
