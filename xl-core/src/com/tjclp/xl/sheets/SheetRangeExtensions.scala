...
object rangeSyntax:
  extension (sheet: Sheet)
     ...
     * @return
     *   Updated sheets with filled cells
     */
     ...
     *
     * Similar to fillBy but uses array-styles indexing instead of Excel coordinates.
     *
     * @param range
     *   The cell range to fill
     * @param f
     ...
     * from truncation or unintended empty cells from padding. Returns ValueCountMismatch errors if
     * counts don't match.
     *
     * @param range
     ...
     * @return
     *   Updated sheets or errors if value count doesn't match range size
     */
