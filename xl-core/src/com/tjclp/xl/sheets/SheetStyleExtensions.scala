...
object styleSyntax:
  extension (sheet: Sheet)
     ...
     *
     * Registers the styles in the sheets's styleRegistry and applies the resulting index to the
     * cell. If the styles is already registered, reuses the existing index.
     */
