...
// Creates sample.xlsx for the Anthropic SDK code execution example
...
val workbook = Workbook(sales, summary)
val outputPath = "examples/anthropic-sdk/sample.xlsx"

Excel.write(workbook, outputPath)
