...
def ivyDeps = Agg(ivy"com.tjclp::xl:0.4.3")

// Or individual modules for minimal footprint:
// ivy"com.tjclp::xl-core:0.4.3"        — Pure domain model only
// ivy"com.tjclp::xl-ooxml:0.4.3"       — Add OOXML read/write
// ivy"com.tjclp::xl-cats-effect:0.4.3" — Add IO streaming
// ivy"com.tjclp::xl-evaluator:0.4.3"   — Add formula evaluation
```
