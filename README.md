...
def ivyDeps = Agg(ivy"com.tjclp::xl:0.2.2")

// Or individual modules for minimal footprint:
// ivy"com.tjclp::xl-core:0.2.2"        — Pure domain model only
// ivy"com.tjclp::xl-ooxml:0.2.2"       — Add OOXML read/write
// ivy"com.tjclp::xl-cats-effect:0.2.2" — Add IO streaming
// ivy"com.tjclp::xl-evaluator:0.2.2"   — Add formula evaluation
```
