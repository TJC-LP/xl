...
// ivy"com.tjclp::xl-core:0.4.0"        — Pure domain model only
// ivy"com.tjclp::xl-ooxml:0.4.0"       — Add OOXML read/write
// ivy"com.tjclp::xl-cats-effect:0.4.0" — Add IO streaming
// ivy"com.tjclp::xl-evaluator:0.4.0"   — Add formula evaluation
```
