...
```scala 3 raw
//> using scala 3.7.4
//> using dep com.tjclp::xl:0.5.0-RC2
...
def ivyDeps = Agg(ivy"com.tjclp::xl:0.5.0-RC2")

// Or individual modules for minimal footprint:
// ivy"com.tjclp::xl-core:0.5.0-RC2"        — Pure domain model only
// ivy"com.tjclp::xl-ooxml:0.5.0-RC2"       — Add OOXML read/write
// ivy"com.tjclp::xl-cats-effect:0.5.0-RC2" — Add IO streaming
// ivy"com.tjclp::xl-evaluator:0.5.0-RC2"   — Add formula evaluation
```
