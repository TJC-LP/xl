...
def ivyDeps = Agg(ivy"com.tjclp::xl:0.23.1")

// Or individual modules for minimal footprint:
// ivy"com.tjclp::xl-core:0.23.1"        — Pure domain model only
// ivy"com.tjclp::xl-ooxml:0.23.1"       — Add OOXML read/write
// ivy"com.tjclp::xl-cats-effect:0.23.1" — Add IO streaming
// ivy"com.tjclp::xl-evaluator:0.23.1"   — Add formula evaluation
```
