...
**8,252 test cases** (verified via `./mill __.test`, 2026-09-25, the Weaver wave): zero failures; the existing style-performance comparison is skipped; the LibreOffice oracle ran (soffice present).
...
| xl-cli | 1626 | command parsing, batch ops, view/eval/export, streaming mode, memory guard (GH-636) |
