...
**5,691 test cases** (verified via `./mill __.test`, 2026-09-06): all passed; one existing style-performance comparison remains ignored.

| Module | Tests | Covers |
|--------|-------|--------|
| xl-evaluator | 2232 | parser, evaluator, 108-function library, dependency graph, cross-sheet formulas, recalculation, structural editing, Excel comparison total order, array CSE semantics |
| xl-core | 1308 | addressing laws, Patch/StylePatch monoids, codecs, optics, RichText, interpolation, render (HTML/SVG), styles DSL, charts, drawings, conditional formatting |
| xl-ooxml | 1088 | round-trips (cells, styles, tables, comments, hyperlinks, charts, drawings, conditional formatting), compression, security (XXE, ZIP bomb), preservation |
