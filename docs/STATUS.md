...
**6,734 test cases** (verified via `./mill __.test`, 2026-09-08, after the 0.21.0 dogfood fixes #606, #608/#609, #612 and the Wave 25 A1 shims): all passed; the style-performance comparison stays ignored, and four subprocess smokes (openpyxl, unwritable-directory) skip where the sandbox lacks the tool or runs as root.
