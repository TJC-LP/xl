...
**6,658 test cases** (verified via `./mill __.test`, 2026-09-08, after the #606 blind-reader fix on the wave-28a stack): all passed; the style-performance comparison stays ignored, and four subprocess smokes (openpyxl, unwritable-directory) skip where the sandbox lacks the tool or runs as root.
