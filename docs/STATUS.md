...
**8,240 test cases** (verified via `./mill __.test`, 2026-09-25, the Weaver wave): zero failures; the existing style-performance comparison is skipped; the LibreOffice oracle ran (soffice present).

| Module | Tests | Covers |
|--------|-------|--------|
| xl-evaluator | 2770 | parser, evaluator, 119-function library, dependency graph, cross-sheet formulas, recalculation, structural editing, Excel comparison total order, array CSE semantics |
| xl-core | 1790 | addressing laws, Patch/StylePatch monoids, codecs, optics, RichText, interpolation, render (HTML/SVG), styles DSL, charts, drawings, conditional formatting |
...
| xl-cli | 1615 | command parsing, batch ops, view/eval/export, streaming mode, memory guard (GH-636) |
