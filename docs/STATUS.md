...
**6,904 test cases** (verified via `./mill __.test`, 2026-09-08, after the 0.21.0 dogfood fixes #606, #608/#609, #612, #637, the #636 memory guard, the Wave 25 A1 shims, the #610/#611 styles preservation and the 0.21.1 streaming fixes #635/#638/#640 and the 0.21.1 formula-semantics cluster #613/#628-#631): all passed; the style-performance comparison stays ignored, and four subprocess smokes (openpyxl, unwritable-directory) skip where the sandbox lacks the tool or runs as root.
