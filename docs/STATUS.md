...
**6,913 test cases** (verified via `./mill __.test`, 2026-09-08, 0.21.1 clusters A/C/D merged): all passed; the style-performance comparison stays ignored, and four subprocess smokes (openpyxl, unwritable-directory) skip where the sandbox lacks the tool or runs as root.
