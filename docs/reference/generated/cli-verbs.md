...
| `view` | `-f` `-s` `--stream` | `o1` (refuses `--eval`, `--format html/svg/png/jpeg/webp/pdf`) | 0 1 2 3 | — | 0.1.0 | View a range as markdown, json, csv, html, svg, png, jpeg, webp or pdf (--eval, --formulas) |
