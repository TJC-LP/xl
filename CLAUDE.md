...
./mill __.test             # Run all tests (6,913)
...
**6,913 tests** by module: xl-evaluator (2447), xl-core (1560), xl-ooxml (1151), xl-cli (1387), xl-cats-effect (170), xl-agent (146), xl prelude probes (52). See `docs/reference/testing-guide.md` for suite structure and patterns.
