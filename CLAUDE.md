...
./mill __.test             # Run all tests (6,663)
...
**6,663 tests** by module: xl-evaluator (2344), xl-core (1547), xl-ooxml (1119), xl-cli (1291), xl-cats-effect (167), xl-agent (145), xl prelude probes (50). See `docs/reference/testing-guide.md` for suite structure and patterns.

## Documentation

- **Roadmap**: `docs/plan/roadmap.md` (single source of truth for work scheduling)
- **Status**: `docs/STATUS.md` (current capabilities, 6,663 tests)
