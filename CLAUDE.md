...
./mill __.test             # Run all tests (5,691)
...
**5,691 tests** by module: xl-evaluator (2232), xl-core (1308), xl-ooxml (1088), xl-cli (754), xl-cats-effect (160), xl-agent (122), xl prelude probes (27). See `docs/reference/testing-guide.md` for suite structure and patterns.

## Documentation

- **Roadmap**: `docs/plan/roadmap.md` (single source of truth for work scheduling)
- **Status**: `docs/STATUS.md` (current capabilities, 5,691 tests)
