...
./mill __.test             # Run all tests (7,317)
...
**7,317 tests** by module: xl-evaluator (2561), xl-core (1659), xl-ooxml (1250), xl-cli (1465), xl-cats-effect (179), xl-agent (147), xl prelude probes (56). See `docs/reference/testing-guide.md` for suite structure and patterns.

## Documentation

- **Roadmap**: `docs/plan/roadmap.md` (single source of truth for work scheduling)
- **Status**: `docs/STATUS.md` (current capabilities, 7,317 tests)
