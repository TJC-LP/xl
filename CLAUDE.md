...
**6,830 tests** by module: xl-evaluator (2441), xl-core (1558), xl-ooxml (1120), xl-cli (1347), xl-cats-effect (168), xl-agent (145), xl prelude probes (51). See `docs/reference/testing-guide.md` for suite structure and patterns.
