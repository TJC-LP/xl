...
./mill __.test             # Run all tests (5,424)
...
**5,424 tests** by module: xl-evaluator (1886), xl-core (1248), xl-ooxml (983), xl-cli (641), xl-cats-effect (141), xl-agent (122), xl prelude probes (26). See `docs/reference/testing-guide.md` for suite structure and patterns.

## Documentation

- **Roadmap**: `docs/plan/roadmap.md` (single source of truth for work scheduling)
- **Status**: `docs/STATUS.md` (current capabilities, 5,424 tests)
