...
./mill __.test             # Run all tests (7,520)
...
**7,520 tests** by module: xl-evaluator (2610), xl-core (1718), xl-ooxml (1283), xl-cli (1521), xl-cats-effect (183), xl-agent (147), xl prelude probes (58). See `docs/reference/testing-guide.md` for suite structure and patterns.

## Documentation

- **Roadmap**: `docs/plan/roadmap.md` (single source of truth for work scheduling)
- **Status**: `docs/STATUS.md` (current capabilities, 7,520 tests)
