...
**6,649 tests** by module: xl-evaluator (2367), xl-core (1536), xl-ooxml (1119), xl-cli (1264), xl-cats-effect (167), xl-agent (145), xl prelude probes (51). See `docs/reference/testing-guide.md` for suite structure and patterns.
