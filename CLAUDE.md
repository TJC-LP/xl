...
./mill __.test             # Run all tests (8,240)
...
**8,240 tests** by module: xl-evaluator (3144), xl-core (1794), xl-ooxml (1290), xl-cli (1621), xl-cats-effect (183), xl-agent (147), xl prelude probes (61). See `docs/reference/testing-guide.md` for suite structure and patterns.

## Documentation

- **Roadmap**: `docs/plan/roadmap.md` (single source of truth for work scheduling)
- **Status**: `docs/STATUS.md` (current capabilities, 8,240 tests)
