...
./mill __.test             # Run all tests (8,496)
...
**8,496 tests** by module: xl-evaluator (3262), xl-core (1826), xl-ooxml (1313), xl-cli (1689), xl-cats-effect (195), xl-agent (147), xl prelude probes (64). See `docs/reference/testing-guide.md` for suite structure and patterns.

## Documentation

- **Roadmap**: `docs/plan/roadmap.md` (single source of truth for work scheduling)
- **Status**: `docs/STATUS.md` (current capabilities, 8,496 tests)
