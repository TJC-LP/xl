...
./mill __.test             # Run all tests (6,904)
...
**6,904 tests** by module: xl-evaluator (2445), xl-core (1558), xl-ooxml (1151), xl-cli (1381), xl-cats-effect (173), xl-agent (145), xl prelude probes (51). See `docs/reference/testing-guide.md` for suite structure and patterns.

## Documentation

- **Roadmap**: `docs/plan/roadmap.md` (single source of truth for work scheduling)
- **Status**: `docs/STATUS.md` (current capabilities, 6,866 tests)
