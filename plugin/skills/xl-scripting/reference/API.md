...
| `Edit.validate(edit)` | `XLResult[Unit]` | the *static*, workbook-free check of one edit: value counts match the area, spans/levels/widths in range, formula syntax, `MoveSheet` names exactly one destination |
