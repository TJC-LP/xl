...
**Operations**: put, putf, style, merge, unmerge, colwidth, rowheight, and more — all 28 listed under "All batch operations" below
...
**All batch operations** (28): `put`, `putf`, `style`, `merge`, `unmerge`, `colwidth`, `rowheight`, `comment`, `remove-comment`, `hyperlink`, `clear`, `col-hide`, `col-show`, `row-hide`, `row-show`, `autofit`, `add-sheet`, `rename-sheet`, `freeze`, `unfreeze`, `copy`, `sheet-view`, `tab-color`, `page-setup`, `header-footer`, `cf` (last five: 0.13.0), `chart` (0.15.0), `autofilter` (0.18.0)
